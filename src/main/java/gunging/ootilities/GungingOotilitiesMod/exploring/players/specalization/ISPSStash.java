...
public class ISPSStash extends ISPPlayerStatement {
     ...
     * @since 1.0.0
     */
    @Override public @NotNull ISPSStash withOptions(@NotNull String options) { return ISPExplorerStatements.STASH; }

    /**
     * @author Gunging
     * @since 1.0.0
     */
    public ISPSStash(@NotNull ResourceLocation name) { super(name); }
