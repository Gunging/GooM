 ...
 * @since 1.0.0
 */
public class ISPSArmor extends ISPPlayerStatement {
     ...
     * @since 1.0.0
     */
    @Override public @NotNull ISPSArmor withOptions(@NotNull String options) { return ISPExplorerStatements.ARMOR; }

    /**
     * @author Gunging
     * @since 1.0.0
     */
    public ISPSArmor(@NotNull ResourceLocation name) { super(name); }
