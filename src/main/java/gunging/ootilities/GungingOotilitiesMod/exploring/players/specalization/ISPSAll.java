 ...
 * @since 1.0.0
 */
public class ISPSAll extends ISPPlayerStatement {
     ...
     * @since 1.0.0
     */
    @Override public @NotNull ISPSAll withOptions(@NotNull String options) { return ISPExplorerStatements.ALL; }

    /**
     * @author Gunging
     * @since 1.0.0
     */
    public ISPSAll(@NotNull ResourceLocation name) { super(name); }
    ...
    public @NotNull ArrayList<ItemStackExplorer<ISPPlayerElaborator, Player>> whenElaborated(@NotNull ISPPlayerElaborator elaborator) {
        ...
        ret.addAll(new ISPPlayerExplorer(ISPExplorerStatements.MAIN).elaborate(elaborator));
