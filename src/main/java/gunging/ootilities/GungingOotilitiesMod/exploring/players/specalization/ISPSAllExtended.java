 ...
 * @since 1.0.0
 */
public class ISPSAllExtended extends ISPPlayerStatement {
     ...
     * @since 1.0.0
     */
    @Override public @NotNull ISPSAllExtended withOptions(@NotNull String options) { return ISPExplorerStatements.ALL_EXTENDED; }

    /**
     * @author Gunging
     * @since 1.0.0
     */
    public ISPSAllExtended(@NotNull ResourceLocation name) { super(name); }
    ...
    public @NotNull ArrayList<ItemStackExplorer<ISPPlayerElaborator, Player>> whenElaborated(@NotNull ISPPlayerElaborator elaborator) {
        ...
        ret.addAll(new ISPPlayerExplorer(ISPExplorerStatements.ALL).elaborate(elaborator));
        ret.addAll(new ISPPlayerExplorer(ISPExplorerStatements.ALL_CRAFTING).elaborate(elaborator));
