 ...
 * @since 1.0.0
 */
public class ISPSChestplate extends ISPEquipmentStatement {
     ...
     * @since 1.0.0
     */
    public ISPSChestplate(@NotNull ResourceLocation statementName) {
        super(statementName);
    }
     ...
     * @since 1.0.0
     */
    @Override public @Nullable ISPSChestplate withOptions(@NotNull String options) {
        return ISPExplorerStatements.CHEST;
    }
    ...
    public @NotNull ArrayList<ItemStackExplorer<ISPPlayerElaborator, Player>> whenElaborated(@NotNull ISPPlayerElaborator elaborator) {
        ...
        ret.add(new ISPPlayerExplorer(ISPExplorerStatements.CHEST));
