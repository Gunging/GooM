...
public class ISPSHead extends ISPEquipmentStatement {
     ...
     * @since 1.0.0
     */
    public ISPSHead(@NotNull ResourceLocation statementName) {
        super(statementName);
    }
     ...
     * @since 1.0.0
     */
    @Override public @Nullable ISPSHead withOptions(@NotNull String options) {
        return ISPExplorerStatements.HEAD;
    }
