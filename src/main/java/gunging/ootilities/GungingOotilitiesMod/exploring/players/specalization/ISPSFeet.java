...
public class ISPSFeet extends ISPEquipmentStatement {
     ...
     * @since 1.0.0
     */
    public ISPSFeet(@NotNull ResourceLocation statementName) {
        super(statementName);
    }
     ...
     * @since 1.0.0
     */
    @Override public @Nullable ISPSFeet withOptions(@NotNull String options) {
        return ISPExplorerStatements.FEET;
    }
