...
public class ISPSMain extends ISPPlayerStatement {
     ...
     * @since 1.0.0
     */
    @Override public @NotNull ISPSMain withOptions(@NotNull String options) { return ISPExplorerStatements.MAIN; }

    /**
     * @author Gunging
     * @since 1.0.0
     */
    public ISPSMain(@NotNull ResourceLocation name) { super(name); }
