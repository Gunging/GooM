...
public class ISESArmor extends ISEEntityStatement {
     ...
     * @since 1.0.0
     */
    @Override public @NotNull ISESArmor withOptions(@NotNull String options) { return ISEExplorerStatements.ARMOR; }

    /**
     * @author Gunging
     * @since 1.0.0
     */
    public ISESArmor(@NotNull ResourceLocation name) { super(name); }
